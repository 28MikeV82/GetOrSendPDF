...
- Название файла: \%<b>grz</b>\%.pdf (если **grz** не передан, то используется **vin**) (предусмотреть возможность смены названия файла)
...
*TBD описать какие свойства отвечают за что и как формируется маска для названия файла.*
...
# Реализация
Текущий статус:
- метод **getPDF** - в процессе
- метод **sendPDF** - не реализован
- кеширование отчетов - не реализовано 
